...
public class CaixaEletronicoService {
    ...
    public CaixaEletronico realizarSaque(NotasSaque notas, BigDecimal valor) throws Exception {
        ...
        caixaEletronico.setValor_total(caixaEletronico.getValor_total().subtract(valor));
